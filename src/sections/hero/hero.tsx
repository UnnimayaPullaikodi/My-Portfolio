	...
	return (
		...
		>
			<div className="relative z-10 flex flex-col items-center gap-2">
				...
				>
					Building Intelligent CRM & Automation Solutions with Dynamics 365 and Power Platform
				</h1>
				<p
		      style={{visibility: "hidden"}}
					ref={descriptionRef}
				...
				>
					I build scalable Dynamics 365 and Power Platform solutions that automate processes, 
					improve customer engagement, and integrate AI-driven innovation.
				</p>
			</div>
